      ...
      <section className="section">
        <div className="container--wide">
          ...
          <p>
            ...
            (Otterpine, 2026). Young and Reed define a cult as a group that meets these ten behavioral conditions. The YM Composite scoring system was developed independently to extend analytical range for dataset-scale application — but the criteria themselves are Young and Reed's.
          </p>
            ...
            {[
              {
                ...
                body: "Each of the ten criteria either checks or does not check. Produces three bands: Not Culty (0–2), Kinda Culty (3–5), Super Culty (6–10). Must be derived from direct application of Young's checklist — never mechanically converted from YM Composite intensity. Mechanical conversion produces systematically inflated results.",
              },
              {
                label: 'YM Composite (Young Mays Composite) Cultiness Score',
          ...
          <div className="section__label">YM Composite Tiers</div>
          ...
          <p>
            ...
            criteria — artificially inflates YM Composite scores and produces
            misleading results.
          </p>
          ...
          <p>
            All scores — across all three output tracks (Young's, YM Composite, and Lifton's) — are generated by an evidence-based jury protocol that eliminates calibration drift:
          </p>
          ...
          <ol style={{color: 'var(--muted)', fontSize: '0.9rem', lineHeight: 1.7}}>
            ...
            <li style={{marginBottom: '0.75rem'}}>For YM Composite: formula applied to the jury-derived intensity scores, using the four-model consensus as the basis.</li>
