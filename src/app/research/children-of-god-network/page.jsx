      ...
      geojsonData.features.forEach(feature => {
        ...
        const popupHTML = `
          <div style="min-width: 250px;">
            <h3 style="margin-bottom: 8px; font-size: 14px; color: #333;">${props.name}</h3>
            <p style="margin-bottom: 6px; font-size: 12px; color: #666;"><strong>${props.city}, ${props.country}</strong></p>
            <p style="margin-bottom: 6px; font-size: 12px; color: #666;"><strong>Type:</strong> ${props.facility_type}</p>
            <p style="margin-bottom: 6px; font-size: 12px; color: #666;"><strong>Timeline:</strong> ${props.opened_year}–${props.closed_year}</p>
            <p style="margin-bottom: 6px; font-size: 12px; color: #666;"><strong>Status:</strong> ${props.status}</p>
  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        <h1>Children of God / Family International: Geographic Network (1968-1994)</h1>
        <p className={styles.subtitle}>
          Academic documentation of 45 compounds, centers, and facilities across 22 countries,
          based on survivor testimony, legal records, and organizational documentation.
        </p>
      </header>
      ...
      <section className={styles.controls}>
        <div className={styles.controlGroup}>
          ...
          <div className={styles.checkboxGroup}>
            <label><input type="checkbox" value="HIGH" defaultChecked /> High (9)</label>
            <label><input type="checkbox" value="MEDIUM" defaultChecked /> Medium (29)</label>
            <label><input type="checkbox" value="LOW" defaultChecked /> Low (7)</label>
          </div>
        </div>

        <div className={styles.controlGroup}>
          <label>Filter by Facility Type</label>
          <div className={styles.checkboxGroup}>
            <label><input type="checkbox" value="Headquarters" defaultChecked /> Headquarters</label>
            <label><input type="checkbox" value="Regional HQ" defaultChecked /> Regional HQ</label>
            <label><input type="checkbox" value="Compound" defaultChecked /> Compound</label>
            <label><input type="checkbox" value="Media Center" defaultChecked /> Media Center</label>
          </div>
        </div>
        ...
        <div className={styles.controlGroup}>
          ...
          <div className={styles.timelineSlider}>
            <input type="range" min="1968" max="1994" defaultValue="1994" id="yearSlider" />
            <div className={styles.timelineYear}>Showing locations active by <span id="currentYear">1994</span></div>
          </div>
        </div>
      </section>

      <div id="map" className={styles.map} style={{ height: '600px' }}></div>
      ...
      <section className={styles.content}>
        ...
        <h3>Timeline: Phases of Expansion</h3>
        <dl>
        ...
        <ul>
          <li><strong>Africa:</strong> Mentioned in 1972 dispersal but no specific locations documented</li>
          <li><strong>Eastern Europe:</strong> Limited data beyond Budapest</li>
          <li><strong>Compound Details:</strong> Many locations lack specific addresses; city-level documentation used</li>
          <li><strong>Timeline Precision:</strong> Some dates approximate based on survivor memory</li>
        </ul>
        ...
        <p>
          <strong>Date:</strong> June 13, 2026<br />
          <strong>Locations Documented:</strong> 45 compounds across 22 countries<br />
          <strong>Timeline Coverage:</strong> 1968-1994<br />
          <strong>Data Quality:</strong> HIGH (9), MEDIUM (29), LOW (7)
        </p>
