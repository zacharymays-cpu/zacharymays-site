...
export default async function CompassPage() {
  const [orgs, referencePoints] = await Promise.all([getOrgs(), getReferencePoints()]);
  ...
  return <CompassClient orgs={orgs} regimes={regimes} presidentialEras={presidentialEras} />;
}
