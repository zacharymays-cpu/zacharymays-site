...
export const metadata = {
  ...
  description: 'Live distribution and instrument-variance analysis of the Cultiness Spectrum dataset — score histogram, YM Composite-vs-Young\'s variance, and tier breakdown computed directly from current data.',
};
      ...
      <section className="hero">
        <div className="container--narrow">
          ...
          <p className="hero__subtitle animate-up-3">
            Score distribution and YM Composite-vs-Young's instrument variance across
