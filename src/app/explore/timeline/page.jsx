...
export const metadata = {
  ...
  description: 'The number of culty organizations (Kinda Culty or Super Culty) counted as active in the United States in each year, computed live from the dataset.',
};
