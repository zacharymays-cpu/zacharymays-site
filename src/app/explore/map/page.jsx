...
export const metadata = {
  ...
  description: 'US map showing organizational headquarters plotted by location, colored by cultiness tier, sized by membership.',
};
...
export default async function MapPage() {
  const res = await fetch(
    ...
    `?select=id,name,category,composite_tier,composite_score,trajectory,` +
  ...
  const withGeo  = orgs.filter(o => o.hq_lat && o.hq_lng);
  const withSize = orgs.filter(o => o.membership_count || o.size_tier);
