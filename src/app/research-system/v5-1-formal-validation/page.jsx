    ...
    <>
      <section className="hero">
        <div className="container--narrow">
          ...
          <h1 className="hero__title">V5.1: Formal Validation Metrics</h1>
          <p className="hero__subtitle">Four-model jury (added Llama) with Krippendorff's alpha validation. Pilot phase for research credibility.</p>
        </div>
      </section>
