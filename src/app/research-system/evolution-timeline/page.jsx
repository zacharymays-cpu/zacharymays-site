    ...
    <>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <p><strong>Scoring outputs (generated in parallel):</strong> Young's Original Score (0-10 binary) + YM Composite Score (0-100% formula). Both provided for each organization.</p>
          ...
          <p><strong>Scoring outputs (generated in parallel):</strong> Young's Original Score (0-10 binary) + YM Composite Score (0-100%) + Lifton's Totalism Score (0-10). Three perspectives provided for each organization.</p>
